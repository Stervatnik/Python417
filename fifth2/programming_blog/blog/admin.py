...
class BlogAdmin(admin.ModelAdmin):
    ...
    fields = ('title', 'slug', 'cat', 'content', 'photo', 'get_html_photo_big', 'is_published', 'time_created', 'time_update')
    readonly_fields = ('get_html_photo_big', 'time_created', 'time_update')
    save_on_top = True
    ...
    def get_html_photo_big(self, obj):
        if obj.photo:
            return mark_safe(f"<img src='{obj.photo.url}' width='500'>")
